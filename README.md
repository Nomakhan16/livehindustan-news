# LiveHindustan - News Portal

A modern, responsive news portal built with Next.js featuring real-time news updates, category filtering, and a clean user interface.
